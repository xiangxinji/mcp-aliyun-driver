...
import { IFileCopyResult, IFileListItem, IFileListResult, IFileMoveResult } from "../typings/file.js";
...
export class FileService extends BaseService {
    ...
    async GetFileInfo({
        ...
        const response = await http.post<IFileListItem>('/adrive/v1.0/openFile/get', {
            drive_id,
            file_id
        })
        return response.data
    ...
    async GetFileInfoByPath({
        ...
        const response = await http.post<IFileListItem>('/adrive/v1.0/openFile/get_by_path', {
            drive_id,
            path
        })
        return response.data
